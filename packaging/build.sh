...
cp "$SRC_DIR/install-omv-cert.sh" "$RPMBUILD_DIR/SOURCES/"
...
cp "$SRC_DIR/install-omv-cert.sh" "$DEB_PKG/opt/mail-archiver/"
chmod 0755 "$DEB_PKG/opt/mail-archiver/install-omv-cert.sh"
