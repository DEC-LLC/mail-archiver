...
cp "$SRC_DIR/install-tls-cert.sh" "$RPMBUILD_DIR/SOURCES/"
cp "$SRC_DIR/tls-sources.conf.example" "$RPMBUILD_DIR/SOURCES/"
...
cp "$SRC_DIR/install-tls-cert.sh" "$DEB_PKG/opt/mail-archiver/"
chmod 0755 "$DEB_PKG/opt/mail-archiver/install-tls-cert.sh"
cp "$SRC_DIR/tls-sources.conf.example" "$DEB_PKG/opt/mail-archiver/"
